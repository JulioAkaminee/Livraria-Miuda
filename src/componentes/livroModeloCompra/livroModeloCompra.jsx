...
const LivroModelo = ({ 
    ...
    preco = 'R$ 00,00', 
    cores = ['#2C4A9C', '#F65E86', '#FA8B71', '#FACD5B', '#2C4A9C'] // Exemplo de cores
}) => {
    const [corAtual, setCorAtual] = useState('');

    useEffect(() => {
        setCorAtual(escolherCorAleatoria(cores)); // Escolhe uma nova cor aleatória da lista ao montar o componente
    }, [cores]);
            ...
            <a href="/informacoeslivro">
                <div className='container_geral'>
                    ...
                    <div className="button-container">
                        <i className="fas fa-heart icon-left"></i> 
                        <button className="comprar-btn">Comprar</button>
                        <i className="fas fa-shopping-cart icon-right"></i> 
                    </div>
                </div>
            </a>
        </>
